...
public class BuyerShoppingList extends ArrayAdapter<Groceries> {
    ...
    public BuyerShoppingList(Activity context, List<Groceries> shoppingList) {
        ...
        super(context, R.layout.activity_buyer_shopping_list, shoppingList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_buyer_shopping_list, null, true);
        ...
        Groceries grocery = shoppingList.get(position);
